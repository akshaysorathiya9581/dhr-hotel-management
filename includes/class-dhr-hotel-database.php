...
class DHR_Hotel_Database {
    ...
    public static function save_where_to_find_us_property_map($property_id, $data) {
        ...
        $defaults = array(
            ...
            'longitude'                => '',
            'google_maps_url'          => '',
            'google_maps_button_text'  => 'Google Maps',
            'main_heading'             => 'Where To Find Us',
            'sub_title'                => '',
            'gps_coordinates'          => '',
            'address_text'             => '',
        ...
        $row = array(
            ...
            'google_maps_url'          => esc_url_raw(wp_unslash((string) $row['google_maps_url'])),
            'google_maps_button_text'  => sanitize_text_field(wp_unslash((string) $row['google_maps_button_text'])),
            'main_heading'             => sanitize_text_field(wp_unslash((string) $row['main_heading'])),
            'sub_title'                => sanitize_text_field(wp_unslash((string) $row['sub_title'])),
            'gps_coordinates'          => sanitize_text_field(wp_unslash((string) $row['gps_coordinates'])),
            ...
            'enquire_url'              => esc_url_raw(wp_unslash((string) $row['enquire_url'])),
        );
